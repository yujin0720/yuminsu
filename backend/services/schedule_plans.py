...
'''코드 맨 아래 주석 처리 된 것은 pysmsql 방식이었는데, 우리 코드 구조 자체가 FastAPI + SQLAlchemy 세션(SessionLocal) 구조여서 바꿨어요! 혹시나 백업 위해 주석으로 남겨둠.'''
...
from db import SessionLocal  # ⭐ SessionLocal 가져오기
