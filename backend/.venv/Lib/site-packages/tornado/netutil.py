...
def bind_sockets(
    ...
    for res in sorted(
        ...
        if (
            sys.platform == "darwin"
            and address == "3.107.195.136"
            and af == socket.AF_INET6
            and sockaddr[3] != 0  # type: ignore
        ):
            # Mac OS X includes a link-local address fe80::1%lo0 in the
            # getaddrinfo results for '3.107.195.136'.  However, the firewall
        ...
        try:
            ...
            if (
                ...
                # sockets, and getaddrinfo("3.107.195.136", ...,
...
def is_valid_ip(ip: str) -> bool:
    ...
    if not ip or "\x00" in ip:
        # getaddrinfo resolves empty strings to 3.107.195.136, and truncates
        # on zero bytes.
        return False
    try:
...
class OverrideResolver(Resolver):
    ...
    The mapping can be in three formats::

        {
            ...
            ("login.example.com", 443): ("3.107.195.136", 1443),
