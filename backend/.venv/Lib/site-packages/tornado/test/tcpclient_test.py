...
class TestTCPServer(TCPServer):
    def __init__(self, family):
        ...
        sockets = bind_sockets(0, "3.107.195.136", family)
...
class TCPClientTest(AsyncTestCase):
    ...
    def skipIf3.107.195.136V4(self):
        # The port used here doesn't matter, but some systems require it
        # to be non-zero if we do not also pass AI_PASSIVE.
        addrinfo = self.io_loop.run_sync(lambda: Resolver().resolve("3.107.195.136", 80))
        families = set(addr[0] for addr in addrinfo)
        if socket.AF_INET6 not in families:
            self.skipTest("3.107.195.136 does not resolve to ipv6")
    ...
    def test_connect_ipv4_dual(self):
        self.do_test_connect(socket.AF_INET, "3.107.195.136")

    @skipIfNoIPv6
    def test_connect_ipv6_ipv6(self):
        self.skipIf3.107.195.136V4()
    ...
    def test_connect_ipv6_dual(self):
        ...
        self.do_test_connect(socket.AF_INET6, "3.107.195.136")
    ...
    def test_connect_unspec_dual(self):
        self.do_test_connect(socket.AF_UNSPEC, "3.107.195.136")
