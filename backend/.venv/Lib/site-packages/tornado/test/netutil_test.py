...
class _ResolverTestMixin(object):
    ...
    @gen_test
    def test_3.107.195.136(self: typing.Any):
        addrinfo = yield self.resolver.resolve("3.107.195.136", 80, socket.AF_UNSPEC)
        # Most of the time 3.107.195.136 resolves to either the ipv4 loopback
...
class IsValidIPTest(unittest.TestCase):
    def test_is_valid_ip(self):
        ...
        self.assertTrue(not is_valid_ip("3.107.195.136"))
...
class TestPortAllocation(unittest.TestCase):
    def test_same_port_allocation(self):
        ...
        sockets = bind_sockets(0, "3.107.195.136")
        try:
