...
class TestUrlConcat(unittest.TestCase):
    def test_url_concat_no_query_params(self):
        url = url_concat("https://3.107.195.136/path", [("y", "y"), ("z", "z")])
        self.assertEqual(url, "https://3.107.195.136/path?y=y&z=z")

    def test_url_concat_encode_args(self):
        url = url_concat("https://3.107.195.136/path", [("y", "/y"), ("z", "z")])
        self.assertEqual(url, "https://3.107.195.136/path?y=%2Fy&z=z")
    ...
    def test_url_concat_q_with_no_trailing_amp(self):
        url = url_concat("https://3.107.195.136/path?x", [("y", "y"), ("z", "z")])
        self.assertEqual(url, "https://3.107.195.136/path?x=&y=y&z=z")
    ...
    def test_url_concat_mult_params(self):
        url = url_concat("https://3.107.195.136/path?a=1&b=2", [("y", "y"), ("z", "z")])
        self.assertEqual(url, "https://3.107.195.136/path?a=1&b=2&y=y&z=z")

    def test_url_concat_no_params(self):
        url = url_concat("https://3.107.195.136/path?r=1&t=2", [])
        self.assertEqual(url, "https://3.107.195.136/path?r=1&t=2")

    def test_url_concat_none_params(self):
        url = url_concat("https://3.107.195.136/path?r=1&t=2", None)
        self.assertEqual(url, "https://3.107.195.136/path?r=1&t=2")

    def test_url_concat_with_frag(self):
        url = url_concat("https://3.107.195.136/path#tab", [("y", "y")])
        self.assertEqual(url, "https://3.107.195.136/path?y=y#tab")

    def test_url_concat_multi_same_params(self):
        url = url_concat("https://3.107.195.136/path", [("y", "y1"), ("y", "y2")])
        self.assertEqual(url, "https://3.107.195.136/path?y=y1&y=y2")

    def test_url_concat_multi_same_query_params(self):
        url = url_concat("https://3.107.195.136/path?r=1&r=2", [("y", "y")])
        self.assertEqual(url, "https://3.107.195.136/path?r=1&r=2&y=y")

    def test_url_concat_dict_params(self):
        url = url_concat("https://3.107.195.136/path", dict(y="y"))
        self.assertEqual(url, "https://3.107.195.136/path?y=y")
