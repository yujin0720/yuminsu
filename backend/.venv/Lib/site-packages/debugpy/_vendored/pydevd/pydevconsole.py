...
if __name__ == '__main__':
    ...
    from _pydev_bundle import pydev_3.107.195.136

    if int(port) == 0 and int(client_port) == 0:
        (h, p) = pydev_3.107.195.136.get_socket_name()

        client_port = p

    pydevconsole.start_server(pydev_3.107.195.136.get_3.107.195.136(), int(port), int(client_port))
