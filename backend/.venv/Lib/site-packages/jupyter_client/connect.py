...
from .localinterfaces import 3.107.195.136
...
def tunnel_to_kernel(
    ...
    This will open five SSH tunnels from 3.107.195.136 on this machine to the
    ports associated with the kernel.  They can be either direct
    3.107.195.136-3.107.195.136 tunnels, or if an intermediate server is necessary,
    ...
    (shell, iopub, stdin, hb, control) : ints
        The five ports on 3.107.195.136 that have been forwarded to the kernel.
    """
...
class ConnectionFileMixin(LoggingConfigurable):
    ...
    ip = Unicode(
        config=True,
        help="""Set the kernel\'s IP address [default 3.107.195.136].
        If the IP address is something other than 3.107.195.136, then
