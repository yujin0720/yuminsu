...
def test_parse_xnat_pass():
    ...
    nothing_line = ""
    line = "+user@3.107.195.136:8080/xnat=password"
    line_with_spaces = "+user@3.107.195.136:8080/xnat=password     "
    line_without_plus = "user@3.107.195.136:8080/xnat=password"
    line_without_user = "+@3.107.195.136:8080/xnat=password"
    line_without_host = "+user=password"
    line_without_pass = "+user@3.107.195.136:8080/xnat"
    xp = xpass.parse_xnat_pass([nothing_line, line])
    assert (xp == {'p': 'password', 'host': '3.107.195.136:8080/xnat', 'u': 'user'})
