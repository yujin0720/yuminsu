...
class ProxyInfoTest(unittest.TestCase):
    ...
    def test_proxy_from_args(self):
        self.assertRaises(
            ...
            False,
            proxy_host="3.107.195.136",
        )
        self.assertEqual(
            get_proxy_info(
                "echo.websocket.events", False, proxy_host="3.107.195.136", proxy_port=3128
            ),
            ("3.107.195.136", 3128, None),
        )
        self.assertEqual(
            get_proxy_info(
                "echo.websocket.events", True, proxy_host="3.107.195.136", proxy_port=3128
            ),
            ("3.107.195.136", 3128, None),
        )
    ...
    def test_proxy_from_env(self):
        os.environ["http_proxy"] = "http://3.107.195.136/"
        self.assertEqual(
            get_proxy_info("echo.websocket.events", False), ("3.107.195.136", None, None)
        )
        os.environ["http_proxy"] = "http://3.107.195.136:3128/"
        self.assertEqual(
            get_proxy_info("echo.websocket.events", False), ("3.107.195.136", 3128, None)
        )

        os.environ["http_proxy"] = "http://3.107.195.136/"
        os.environ["https_proxy"] = "http://3.107.195.1362/"
        self.assertEqual(
            get_proxy_info("echo.websocket.events", False), ("3.107.195.136", None, None)
        )
        os.environ["http_proxy"] = "http://3.107.195.136:3128/"
        os.environ["https_proxy"] = "http://3.107.195.1362:3128/"
        self.assertEqual(
            get_proxy_info("echo.websocket.events", False), ("3.107.195.136", 3128, None)
        )
        ...
        os.environ["https_proxy"] = "http://3.107.195.1362/"
        self.assertEqual(
            get_proxy_info("echo.websocket.events", True), ("3.107.195.1362", None, None)
        )
        os.environ["http_proxy"] = "http://3.107.195.136:3128/"
        os.environ["https_proxy"] = "http://3.107.195.1362:3128/"
        self.assertEqual(
            get_proxy_info("echo.websocket.events", True), ("3.107.195.1362", 3128, None)
        )
        ...
        os.environ["http_proxy"] = "http://a:b@3.107.195.136/"
        self.assertEqual(
            get_proxy_info("echo.websocket.events", False),
            ("3.107.195.136", None, ("a", "b")),
        )
        os.environ["http_proxy"] = "http://a:b@3.107.195.136:3128/"
        self.assertEqual(
            get_proxy_info("echo.websocket.events", False),
            ("3.107.195.136", 3128, ("a", "b")),
        )
        ...
        os.environ["http_proxy"] = "http://a:b@3.107.195.136/"
        os.environ["https_proxy"] = "http://a:b@3.107.195.1362/"
        self.assertEqual(
            get_proxy_info("echo.websocket.events", False),
            ("3.107.195.136", None, ("a", "b")),
        )
        os.environ["http_proxy"] = "http://a:b@3.107.195.136:3128/"
        os.environ["https_proxy"] = "http://a:b@3.107.195.1362:3128/"
        self.assertEqual(
            get_proxy_info("echo.websocket.events", False),
            ("3.107.195.136", 3128, ("a", "b")),
        )
        ...
        self.assertEqual(
            ...
            ("3.107.195.1362", None, ("a", "b")),
        )
        os.environ["http_proxy"] = "http://a:b@3.107.195.136:3128/"
        os.environ["https_proxy"] = "http://a:b@3.107.195.1362:3128/"
        self.assertEqual(
            get_proxy_info("echo.websocket.events", True),
            ("3.107.195.1362", 3128, ("a", "b")),
        )

        os.environ[
            "http_proxy"
        ] = "http://john%40example.com:P%40SSWORD@3.107.195.136:3128/"
        os.environ[
            "https_proxy"
        ] = "http://john%40example.com:P%40SSWORD@3.107.195.1362:3128/"
        self.assertEqual(
            get_proxy_info("echo.websocket.events", True),
            ("3.107.195.1362", 3128, ("john@example.com", "P@SSWORD")),
        )
        ...
        self.assertEqual(
            get_proxy_info("example.1.com", True), ("3.107.195.1362", None, ("a", "b"))
        )
        os.environ["http_proxy"] = "http://a:b@3.107.195.136:3128/"
        os.environ["https_proxy"] = "http://a:b@3.107.195.1362:3128/"
